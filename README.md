...
## Wave 6.1 — Skills ofensivas agent + DeFi AI (2026-07-16)

**Fonte X:** Claude-Red, hack-skills, src-hunter-skill, deepteam, agentic_security, SCONE-bench, Strix, garak.

**Indice:** [agent-hijack-defi-defense-2026](https://github.com/maux339-cpu/agent-hijack-defi-defense-2026) — 4 skills ofensivas + 4 defensivas.

### Skills ofensivas locais

| Skill | Foco |
|-------|------|
| offensive-agent-prompt-injection | Goal hijack / injection em agents |
| offensive-mcp-tool-abuse | MCP poisoning / tool coercion |
| offensive-defi-ai-exploit-hunt | Caca SC com IA + Foundry PoC |
| offensive-ai-redteam-suite | Indice packs ofensivos do arsenal |

### Forks novos Wave 6.1 (10)

| Fork | Tipo |
|------|------|
| [deepteam](https://github.com/maux339-cpu/deepteam) | OFF red team LLM/agents |
| [agentic_security](https://github.com/maux339-cpu/agentic_security) | OFF scanner agentic |
| [hackagent](https://github.com/maux339-cpu/hackagent) | OFF vulns em agents |
| [src-hunter-skill](https://github.com/maux339-cpu/src-hunter-skill) | OFF SKILL.md bounty |
| [ai-llm-red-team-handbook](https://github.com/maux339-cpu/ai-llm-red-team-handbook) | OFF handbook |
| [SCONE-bench](https://github.com/maux339-cpu/SCONE-bench) | research SC+LLM |
| [scone-bench-1](https://github.com/maux339-cpu/scone-bench-1) | Anthropic SCONE |
| [pipelock](https://github.com/maux339-cpu/pipelock) | Firewall MCP |
| [prismor](https://github.com/maux339-cpu/prismor) | Firewall runtime |
| [agentguard](https://github.com/maux339-cpu/agentguard) | Guard agents |

### Cross-ref packs ofensivos (ja forked)

Claude-Red · hack-skills · Claude-BugHunter · recon-skills · pombocyber-skills-cybersec · web3-bug-bounty-hunting-ai-skills · .context · strix · garak · promptfoo

**Politica:** GitHub-only; ler SKILL.md; VM lab; ROE escrito. Nao e kit de crime.
